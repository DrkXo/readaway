...
void main() {
  group('ComicArchiveAdapter with Mockito', () {
    ...
    test('mockAdapter lists image entries and fetches page bytes correctly', () {
    ...
    test('ComicArchiveAdapter static utility helpers', () {
      ...
      expect(ComicArchiveAdapter.normalizePath(r'folder\sub\page.jpg'), 'folder/sub/page.jpg');
      expect(ComicArchiveAdapter.compareAlphanumeric('page_2.jpg', 'page_10.jpg'), lessThan(0));
    });
  });
}
