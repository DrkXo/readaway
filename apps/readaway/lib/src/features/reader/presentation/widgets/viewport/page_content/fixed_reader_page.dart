...
class FixedReaderPage extends StatefulWidget {
  const FixedReaderPage({
    super.key,
    required this.index,
    required this.state,
  ...
  @override
  State<FixedReaderPage> createState() => _FixedReaderPageState();
}

class _FixedReaderPageState extends State<FixedReaderPage> {
