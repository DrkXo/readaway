...
@useResult
$Res call({
 bool loading, Failure? failure, String? error, String? fileName, int pageCount, int currentPage, List<String?>? pageHtmls, List<List<ReaderLink>?>? pageLinks, Set<int> loadingPages, List<OutlineItem>? outline, String? bookTitle, String? author, String? documentPath, UiFeedback? transientFeedback, bool ttsActive, int? ttsCurrentPage, int? virtualPageCount, int? currentVirtualPage
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool loading,  Failure? failure,  String? error,  String? fileName,  int pageCount,  int currentPage,  List<String?>? pageHtmls,  List<List<ReaderLink>?>? pageLinks,  Set<int> loadingPages,  List<OutlineItem>? outline,  String? bookTitle,  String? author,  String? documentPath,  UiFeedback? transientFeedback,  bool ttsActive,  int? ttsCurrentPage,  int? virtualPageCount,  int? currentVirtualPage)  $default,) {final _that = this;
switch (_that) {
case _ReaderState():
return $default(_that.loading,_that.failure,_that.error,_that.fileName,_that.pageCount,_that.currentPage,_that.pageHtmls,_that.pageLinks,_that.loadingPages,_that.outline,_that.bookTitle,_that.author,_that.documentPath,_that.transientFeedback,_that.ttsActive,_that.ttsCurrentPage,_that.virtualPageCount,_that.currentVirtualPage);case _:
  throw StateError('Unexpected subclass');
