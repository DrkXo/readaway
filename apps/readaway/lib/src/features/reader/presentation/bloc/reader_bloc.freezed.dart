...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String path,  String? fileName,  ReaderEngineMode engineMode)?  openDocument,TResult Function( ReaderEngineMode newMode)?  engineModeChanged,TResult Function( int index)?  pageChanged,TResult Function( int index)?  loadPage,TResult Function()?  closeDocument,TResult Function()?  ttsStart,TResult Function()?  ttsClose,TResult Function()?  consumeFeedback,TResult Function( String message)?  ttsErrorOccurred,TResult Function()?  jumpToTtsPage,TResult Function( int pageIndex)?  ttsPageAdvanced,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OpenDocument() when openDocument != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String path,  String? fileName,  ReaderEngineMode engineMode)  openDocument,required TResult Function( ReaderEngineMode newMode)  engineModeChanged,required TResult Function( int index)  pageChanged,required TResult Function( int index)  loadPage,required TResult Function()  closeDocument,required TResult Function()  ttsStart,required TResult Function()  ttsClose,required TResult Function()  consumeFeedback,required TResult Function( String message)  ttsErrorOccurred,required TResult Function()  jumpToTtsPage,required TResult Function( int pageIndex)  ttsPageAdvanced,}) {final _that = this;
switch (_that) {
case _OpenDocument():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String path,  String? fileName,  ReaderEngineMode engineMode)?  openDocument,TResult? Function( ReaderEngineMode newMode)?  engineModeChanged,TResult? Function( int index)?  pageChanged,TResult? Function( int index)?  loadPage,TResult? Function()?  closeDocument,TResult? Function()?  ttsStart,TResult? Function()?  ttsClose,TResult? Function()?  consumeFeedback,TResult? Function( String message)?  ttsErrorOccurred,TResult? Function()?  jumpToTtsPage,TResult? Function( int pageIndex)?  ttsPageAdvanced,}) {final _that = this;
switch (_that) {
case _OpenDocument() when openDocument != null:
return openDocument(_that.path,_that.fileName,_that.engineMode);case _EngineModeChanged() when engineModeChanged != null:
return engineModeChanged(_that.newMode);case _PageChanged() when pageChanged != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OpenDocument&&(identical(other.path, path) || other.path == path)&&(identical(other.fileName, fileName) || other.fileName == fileName)&&const DeepCollectionEquality().equals(other.engineMode, engineMode));
}


@override
int get hashCode => Object.hash(runtimeType,path,fileName,const DeepCollectionEquality().hash(engineMode));
...
/// Create a copy of ReaderEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? path = null,Object? fileName = freezed,Object? engineMode = freezed,}) {
  return _then(_OpenDocument(
path: null == path ? _self.path : path // ignore: cast_nullable_to_non_nullable
as String,fileName: freezed == fileName ? _self.fileName : fileName // ignore: cast_nullable_to_non_nullable
as String?,engineMode: freezed == engineMode ? _self.engineMode : engineMode // ignore: cast_nullable_to_non_nullable
as ReaderEngineMode,
  ));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EngineModeChanged&&const DeepCollectionEquality().equals(other.newMode, newMode));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(newMode));
...
/// Create a copy of ReaderEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? newMode = freezed,}) {
  return _then(_EngineModeChanged(
newMode: freezed == newMode ? _self.newMode : newMode // ignore: cast_nullable_to_non_nullable
as ReaderEngineMode,
  ));
}
...
@useResult
$Res call({
 bool loading, Failure? failure, String? error, String? fileName, bool isReflowable, int pageCount, int currentPage, List<String?>? pageHtmls, List<List<ReaderLink>?>? pageLinks, List<ui.Image?>? pageImages, Set<int> loadingPages, List<OutlineItem>? outline, String? bookTitle, String? author, String? documentPath, UiFeedback? transientFeedback, bool ttsActive, int? ttsCurrentPage, ReaderEngineMode engineMode
});
...
as int?,engineMode: freezed == engineMode ? _self.engineMode : engineMode // ignore: cast_nullable_to_non_nullable
as ReaderEngineMode,
  ));
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool loading,  Failure? failure,  String? error,  String? fileName,  bool isReflowable,  int pageCount,  int currentPage,  List<String?>? pageHtmls,  List<List<ReaderLink>?>? pageLinks,  List<ui.Image?>? pageImages,  Set<int> loadingPages,  List<OutlineItem>? outline,  String? bookTitle,  String? author,  String? documentPath,  UiFeedback? transientFeedback,  bool ttsActive,  int? ttsCurrentPage,  ReaderEngineMode engineMode)  $default,) {final _that = this;
switch (_that) {
case _ReaderState():
return $default(_that.loading,_that.failure,_that.error,_that.fileName,_that.isReflowable,_that.pageCount,_that.currentPage,_that.pageHtmls,_that.pageLinks,_that.pageImages,_that.loadingPages,_that.outline,_that.bookTitle,_that.author,_that.documentPath,_that.transientFeedback,_that.ttsActive,_that.ttsCurrentPage,_that.engineMode);case _:
  throw StateError('Unexpected subclass');
